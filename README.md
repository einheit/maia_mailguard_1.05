...
That said, users are not required to use the web interface, and many choose not to, as all messages can be confirmed or reported in daily message digest emails (which are also optional BTW).
