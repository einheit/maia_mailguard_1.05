...
echo 
echo "This install script is for Ubuntu 24.04 LTS using mysql"
...
apt install -y liblwp-protocol-https-perl
#
#
...
#pear install channel://pear.php.net/Image_Canvas-0.5.0
