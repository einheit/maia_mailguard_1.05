...
# config file variables from /usr/local/etc/maia-mailguard/maia.conf
...
# read configuration file (/usr/local/etc/maia-mailguard/maia.conf)
load_config_file('/usr/local/etc/maia-mailguard/maia.conf');
