...
}registerCommands('exclusive,exclusivestatus,exclusiveoverride');var olOverrideIsSet;
...
function parseExclusiveExtras(pf,i,ar)
{
    ...
    if (k<ar.length) {if (ar[k]==EXCLUSIVEOVERRIDE) { if(pf!='ol_') { olOverrideIsSet=true;
    } return k; }
